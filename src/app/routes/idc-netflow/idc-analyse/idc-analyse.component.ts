...
@Component({
  selector: 'app-idc-analyse',
  templateUrl: './idc-analyse.component.html',
  styleUrls: ['./idc-analyse.component.css']
})
export class IdcAnalyseComponent implements OnInit {
  ...
  listOfColumns: ColumnItem[] = [
    ...
    },
    {
      name: '峰值流速(Gbps)',
      sortOrder: null,
      sortFn: (a: DataItem, b: DataItem) => a.upstream - b.upstream,
      sortDirections: ['ascend', 'descend', null],
      filterMultiple: true,
      listOfFilter: null,
      filterFn: null
  ...
  customNetflowOfData: Custom[] = [
    {
      compName: '全部',
      total: '2352.522/4051.534',
      inPro: '243.015/1104.195',
      outPro: '1593.242/3051.423',
      outNet: '13.015/524.425',
      high: '72.561/63.5%',
      low: '30.105/36.5%',
      inProRent: '40.5%',
      inNetRent: '56.2%',
  ...
  alignTopCharts(): void {
    this.alignTopBarOption = {
      ...
      xAxis: [
        {
          type: 'category',
          data: ['湖北', '山东', '广东', '湖南', '河南', '上海', '重庆', '江苏', '河北', '江西'],
          axisTick: {
            alignWithLabel: true
          },
