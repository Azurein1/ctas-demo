...
@Component({
  selector: 'app-cdn-analyse',
  templateUrl: './cdn-analyse.component.html',
  styleUrls: ['./cdn-analyse.component.css']
})
export class CdnAnalyseComponent implements OnInit {
      ...
      series: [
        {
          ...
          radius: '50%',
          data: [
            {value: 2314.325, name: '家客'},
            {value: 2243.699, name: '集客'},
            {value: 698.371, name: 'WLAN'},
            {value: 464.527, name: '手机'},
          ],
          emphasis: {
            itemStyle: {
              shadowBlur: 10,
